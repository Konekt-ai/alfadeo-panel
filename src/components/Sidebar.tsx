...
export function Header() {
  return (
    <header className="h-14 bg-white border-b border-gray-200 flex items-center px-6 shrink-0">
      ...
      <div className="ml-3 pl-3 border-l border-gray-200 text-xs text-gray-400 font-medium uppercase tracking-wider">
        Panel interno
      </div>
    </header>
  )
...
export default function Sidebar() {
  ...
  return (
    <aside className="w-52 bg-[#003366] flex flex-col shrink-0">
