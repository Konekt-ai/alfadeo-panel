    ...
    <div className="p-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            ...
            >
              <div className="flex items-start justify-between">
                <div className="min-w-0">
                  <h2 className="text-lg font-semibold text-gray-900 truncate">{p.nombre}</h2>
                  <p className="text-base text-gray-500 mt-0.5">{metodoLabel[p.metodo_ingesta as MetodoIngesta] ?? p.metodo_ingesta}</p>
                </div>
                <span className={`shrink-0 text-sm font-semibold px-2.5 py-1 rounded-full ${
              ...
              <div className="mt-4 flex items-end justify-between">
                <div>
                  ...
                  <div className="text-base text-gray-500">productos en catálogo</div>
                </div>
        ...
        {(!proveedores || proveedores.length === 0) && !error && (
          <div className="col-span-full text-center py-20 text-gray-400 text-base">
